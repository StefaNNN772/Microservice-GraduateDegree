...
namespace ReservationService.Helpers
{
    public class EmailService
    {
                                        ...
                                        byte[] attachmentData, string attachmentFileName, string attachmentMimeType = "application/pdf")
        {
            try
            {
                Console.WriteLine($"[EmailService] Starting to send email to {recipientEmail}");
                Console.WriteLine($"[EmailService] SMTP: {smtpServer}:{port}");
                Console.WriteLine($"[EmailService] Sender: {senderEmail}");
                Console.WriteLine($"[EmailService] Attachment size: {attachmentData.Length} bytes");
