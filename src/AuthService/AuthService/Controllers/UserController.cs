    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDTO>> GetUserById(long userId)
        {
            ...
            var userDTO = new UserDTO
            {
                ...
                Email = user.Email,
                DiscountType = user.DiscountType ?? DiscountType.None,
                DiscountStatus = user.DiscountStatus,
                ProfileImagePath = !string.IsNullOrEmpty(user.ProfileImagePath)
                                    ? $"{Request.Scheme}://{Request.Host}/profile-image/{user.ProfileImagePath}"
                                    : null,
        ...
        public async Task<ActionResult<UserDTO>> GetUserEmailId(string email)
        {
        ...
        public async Task<IActionResult> GetProfileImage(string fileName)
        {
            ...
            try
            {
                var uploadPath = "/app/uploads/profile-images";
