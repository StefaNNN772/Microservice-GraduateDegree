...
namespace AuthService.Services
{
    public class UserService
    {
        ...
        public UserService(UserRepository userRepository, EmailService emailService, FileStorageService fileStorageService)
        {
        ...
        {
            _fileStorageService.DeleteFile(user.ProfileImagePath, isProfileImage: true);

            var fileName = await _fileStorageService.SaveProfileImageAsync(profileImage, user.Id);

            var updatedUser = await _userRepository.AddProfileImage(user, fileName);
